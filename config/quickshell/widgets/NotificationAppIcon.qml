...
import "../configs/utils/NotificationUtils.js" as NotificationUtils
    ...
    Loader {
        ...
        sourceComponent: StyledMaterialSymbol {
            ...
            color: (root.urgency == NotificationUrgency.Critical) ? 
                Colors.mix(Appearance.colors.colOnSecondary, Appearance.colors.colOnSecondaryContainer, 0.1) :
